export default function RoutineLevel1() {
  return (
    <div
    ...
    >
      <section className="insight-container">
        ...
        <p className="insight-summary" style={{ marginBottom: "1.5rem", color: "#1a1a1a" }}>
          You naturally manage daily routines with flexibility and ease. Changes in plans rarely cause disruption, and you adapt well to new schedules or environments.
        </p>
        ...
        <div className="insight-block" style={{ marginBottom: "1.5rem" }}>
          ...
          <ul style={{ marginTop: "0.75rem", paddingLeft: "1.25rem", color: "#1a1a1a" }}>
            <li>Comfortable with varied daily schedules</li>
            <li>Quick to adapt when routines change</li>
            <li>Balances structure and spontaneity with ease</li>
          </ul>
        </div>
        ...
        <div className="insight-block">
          ...
          <p style={{ marginTop: "0.75rem", color: "#1a1a1a" }}>
            Your natural adaptability to routine changes is a strength that helps you navigate daily life confidently.
          </p>
        </div>
      </section>
    </div>
